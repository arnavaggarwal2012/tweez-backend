...
const createTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (success) {
            const updateUserSuccess = yield (0, user_repositories_1.updateUserWithTweetIdRepo)(tweet.adminId, tweet.tweetId);
...
const updateTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const success = yield (0, tweet_repositories_1.updateTweetRepo)(updatedTweet, updatedTweet.tweetId);
        if (success) {
...
const deleteTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const tweetId = req.params.tweetId;
    try {
        const tweet = yield (0, tweet_repositories_1.deleteTweetRepo)(tweetId);
        if (tweet) {
